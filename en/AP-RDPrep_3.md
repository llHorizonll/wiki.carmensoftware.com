...
description: 
published: true
date: 2026-01-22T08:57:01.338Z
tags: 
editor: markdown
dateCreated: 2026-01-22T08:56:42.834Z
---

## การโอนย้ายข้อมูลใบแนบ ภ.ง.ด.3 ผ่านโปรแกรม RDPrep

การโอนย้ายข้อมูลใบแนบ ภ.ง.ด.3 ผ่านโปรแกรม RDPrep <img src="images/ap-72.png" style="display: inline-block;" />

1. เปิดโปรแกรมโอนย้ายข้อมูล RDPrep

2. กด โอนย้ายข้อมูล

![alt text](images/ap-73.png)

3. เลือกประเภท โอนย้ายข้อมูล ภ.ง.ด. 3 กด <img src="images/ap-74.png" style="display: inline-block;" />

![alt text](images/ap-75.png)

โปรแกรมแสดงหน้าจอ “โอนย้ายข้อมูลแบบยื่นรายการภาษีเงินได้หัก ณ ที่จ่าย ภ.ง.ด.3”

![alt text](images/ap-76.png)
...
2. กดเลือก ประเภทสาขา อย่างใดอย่างหนึ่ง จากรายการโปรแกรมดังนี้
   ...
   ให้ผู้ใช้งานทำเครื่องหมาย <img src="images/ap-78.png" style="display: inline-block;" /> ลงหน้ารายการที่ต้องการเลือก

3. ระบุ สาขาที่
4. ไฟล์สำหรับการโอนย้าย กด <img src="images/ap-79.png" style="display: inline-block;" />
...
10. เมื่อกำหนดรหัสข้อมูลเรียบร้อยแล้ว กดปุ่ม <img src="images/ap-81.png" style="display: inline-block;" /> เพื่อเข้าสู่ ขั้นตอนที่ 2 กำหนดตำแหน่งข้อมูล
...
![alt text](images/ap-82.png)

![alt text](images/ap-83.png)

![alt text](images/ap-84.png)

2.) เมื่อกำหนดตำแหน่งข้อมูลเรียบร้อยแล้วให้กดปุ่ม <img src="images/ap-85.png" style="display: inline-block;" /> เพื่อเข้าสู่ ขั้นตอนที่ 3 ผลการโอนย้าย

## ขั้นตอนที่ 3 ผลการโอนย้าย

โปรแกรมจะทำการตรวจสอบข้อมูลและแสดงผลการโอนย้ายให้ตรวจสอบข้อมูล หากถูกต้องให้กดปุ่ม <img src="images/ap-81.png" style="display: inline-block;" /> เพื่อเข้าสู่ ขั้นตอนที่ 4 สรุปรายการภาษี

![alt text](images/ap-86.png)
![alt text](images/ap-87.png)
...
2. ผู้ใช้งานสามารถพิมพ์ใบแนบที่บันทึกลงโปรแกรมได้ โดยกดปุ่ม <img src="images/ap-88.png" style="display: inline-block;" />

3. ผู้ใช้งานสามารถพิมพ์แบบได้ โดยกดปุ่ม <img src="images/ap-89.png" style="display: inline-block;" />

4. กรณีที่ผู้ใช้งานยังบันทึกข้อมูลใบแนบไม่ครบถ้วน และต้องการบันทึกข้อมูลใบแนบที่บันทึก
   เบื้องต้นไว้ก่อน ให้กดปุ่ม <img src="images/ap-90.png" style="display: inline-block;" />
   
5. กรณีที่ผู้ใช้งานบันทึกข้อมูลใบแนบครบถ้วนแล้ว และต้องการสร้างไฟล์ข้อมูล ให้กดปุ่ม <img src="images/ap-91.png" style="display: inline-block;" />

   โปรแกรมแสดงกล่องข้อความ “บันทึกข้อมูลเรียบร้อยแล้ว”

   ![alt text](images/ap-92.png)

6. กดปุ่ม <img src="images/ap-93.png" style="display: inline-block;" />

   โปรแกรมแสดงหน้าจอการดาวน์โหลดไฟล์แบบ

   ![alt text](images/ap-94.png)
...
10. กดปุ่ม <img src="images/ap-95.png" style="display: inline-block;" />
