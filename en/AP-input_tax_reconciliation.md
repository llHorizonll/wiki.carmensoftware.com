...
description: 
published: true
date: 2026-01-22T08:57:03.012Z
tags: 
editor: markdown
dateCreated: 2026-01-22T08:56:45.117Z
---
...
<img src="images/ap-44.png" style="height: 1.3em; vertical-align: middle; display: inline;" />
</p>
...
10.	กด <img src="images/ap-180.png" style="height: 1.8em; vertical-align: middle; display: inline;" /> เพื่อบันทึกข้อมูล หรือ Cancel เพื่อยกเลิก
![alt text](images/ap-149.png)
...
12.	ทำตามขั้นตอน 1 และ 2 อีกครั้ง จากนั้น click <img src="images/ap-44.png" style="display: inline-block;" /> 
...
16.1.	ทำตามขั้นตอน 1 และ 2 อีกครั้ง จากนั้น click  <img src="images/ap-44.png" style="display: inline-block;" />

16.2.	กดปุ่ม “IMPORT FROM FILE” และเลือก Excel file ที่ตาม Template ของระบบ และมีนามสกุล .xlsx เท่านั้น
 ![alt text](images/ap-192.png)
...
17.	 เมื่อบันทึกข้อมูลใบกำกับภาษีทั้งหมด และกด ปุ่ม **<span class="btn">FINISH</span>** จากข้อ 11 ระบบ จะเปิด tab<img src="images/ap-199.png" style="display: inline-block;" />
...
17.4.	เลือก ”Export Input TAX.xlsx file” เพื่อ Export ข้อมูลภาษีซื้อให้อยู่ในรูปแบบ Excel ที่ข้อมูลตรงตาม Column
 ![alt text](images/ap-197.png)
ตัวอย่างรายงานภาษีซื้อ
 ![alt text](images/ap-198.png)
