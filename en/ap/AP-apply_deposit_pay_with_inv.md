...
1. สร้าง A/P Invoice เพื่อล้าง Deposit และลอดยอดหนี้
   ...
   1.3. เลือก Deposit Invoice ที่ตั้งเอาไว้ก่อนหน้านี้ <img src="./ap-106.png"  />

   1.4. กด Copy เพื่อนำข้อมูลของ Deposit มาใช้ <img src="./ap-107.png"  />
   ...
   1.6. ในส่วนของ Header สามารถใส่เลขที่ invoice เพื่อ running เอกสารภายใน และใส่ description เพื่อเพิ่มการอธิบาย <img src="./ap-108.png"  />
   ...
   1.9. กด **<span class="btn">OK</span>** เพื่อเสร็จสิ้นขั้นตอน <img src="./ap-110.png"  />
...
2. การสร้าง Payment โดยนำ Deposit มาใช้คู่กับ Invoice ของสินค้าหรือบริการที่ได้รับ
   ...
   2.6. กด **<span class="btn">OK</span>** เพื่อเสร็จสิ้นขั้นตอน <img src="./ap-112.png"  />
