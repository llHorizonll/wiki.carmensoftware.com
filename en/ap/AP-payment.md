...
![alt text](ap-131.png)
3. Click<img src="./add_icon.png" style="display: inline-block;" /> ระบบจะแสดงหน้าจอ Payment Blank Form เพื่อให้ระบุข้อมูลการชำระเงิน
...
5. กดปุ่ม <img src="./ap-25.png" style="display: inline-block;" />เพื่อเลือก Invoice ที่จะนำไปตัดชำระ
![alt text](ap-132.png)
