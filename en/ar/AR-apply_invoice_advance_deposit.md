...
5. ขั้นตอนการเลือก Invoice โดยกดปุ่ม <img src="./ar-42.png" style="display: inline-block;" /> SELECT INVOICE FOR SETTLEMENT
...
7. ให้ติ๊กถูก <img src="./ar-62.png" style="display: inline-block;" /> เพื่อกำหนดวันตัด aging ให้เป็นวันเดียวกันกับ Receipt Date
