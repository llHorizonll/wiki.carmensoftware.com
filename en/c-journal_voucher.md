...
description: 
published: true
date: 2026-01-22T08:57:09.299Z
tags: 
editor: markdown
dateCreated: 2026-01-22T08:56:56.033Z
---
...
1.3 กดปุ่ม <img src="images/add_icon.png" style="display: inline-block;" />

![alt text](images/gl-110.png)
...
2.3 Click สัญลักษณ์ <img src="images/gl-5.png" style="display: inline-block;" /> ใน JV ที่ต้องการจะทำการคัดลอก

![alt text](images/gl-111.png)

2.4 ระบบจะเปิด JV ที่เลือกมา

2.5 Click เมนูคำสั่ง <img src="images/copy_icon.png" style="display: inline-block;" /> เพื่อทำการคัดลอก JV ใบนั้น

![alt text](images/gl-7.png)
...
2.6.1.2 Click เลือก <img src="images/copy_icon.png" style="display: inline-block;" /> และเลือก Copy to new Journal Voucher

2.6.1.3 Click **<span class="btn">OK</span>** เพื่อยืนยันการคัดลอก

<p align="center">
    <img src="images/gl-9.png"  />
</p>

2.6.1.4 ทำการแก้ไขข้อมูลในส่วน Description และ Click เพื่อเข้าไปแก้ไขข้อมูลของแต่ละ Detail

![alt text](images/gl-10.png)
...
![alt text](images/gl-12.png)

2.6.1.6 เปิดเอกสาร JV ที่ต้องการคัดลอก

2.6.1.7 Click เลือก <img src="images/copy_icon.png" style="display: inline-block;" /> และเลือก Copy and reverse transaction

2.6.1.8 Click **<span class="btn">OK</span>** เพื่อยืนยันการคัดลอก

<p align="center">
    <img src="images/gl-13.png"  />
</p>
...
3.3 กดปุ่ม <img src="images/add_icon.png" style="display: inline-block;" /> ระบบจะแสดงหน้าต่างการสร้าง Journal Voucher

![alt text](images/gl-112.png)

3.4 กดปุ่ม <img src="images/template_btn.png" style="display: inline-block;" /> เพื่อเลือก Template

![alt text](images/gl-20.png)

3.5 ระบบจะแสดงหน้าต่าง Select Template ให้Click เลือก Select from template และกด **<span class="btn">NEXT</span>**

![alt text](images/gl-21.png)
...
1.1. กดปุ่ม <img src="images/edit_icon.png" style="display: inline-block;" /> เพื่อแก้ไขเอกสาร JV ที่เปิดขึ้นมา

1.2. กดปุ่ม <img src="images/void_icon.png" style="display: inline-block;" /> เพื่อยกเลิกเอกสาร JV ที่เปิดขึ้นมา

1.3. กดปุ่ม <img src="images/print_icon.svg" style="display: inline-block;" /> เพื่อพิมพ์เอกสาร Journal Voucher
